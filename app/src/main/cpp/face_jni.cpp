...
Java_org_tensorflow_demo_FaceNetMobile_FaceModelInit(JNIEnv *env, jobject instance,
...
Java_org_tensorflow_demo_FaceNetMobile_FaceDetect(JNIEnv *env, jobject instance,
...
JNIEXPORT jboolean JNICALL
Java_org_tensorflow_demo_FaceNetMobile_FaceModelUnInit(JNIEnv *env, jobject instance) {
    if (!detection_sdk_init_ok) {
...
Java_org_tensorflow_demo_FaceNetMobile_FaceRecognize(JNIEnv *env, jobject instance,
...
Java_org_tensorflow_demo_FaceNetMobile_FaceEmbFeature(JNIEnv *env, jobject instance,
                                                     jbyteArray faceDate1_, jint w1, jint h1) {
    jbyte *faceDate1 = env->GetByteArrayElements(faceDate1_, NULL);
    unsigned char *faceImageCharDate1 = (unsigned char*)faceDate1;
    ncnn::Mat ncnn_img1 = ncnn::Mat::from_pixels_resize(faceImageCharDate1, ncnn::Mat::PIXEL_RGBA2RGB, w1, h1,112,112);
...
Java_org_tensorflow_demo_FaceNetMobile_calculSimilar(JNIEnv *env, jobject instance,
